...
## [0.2.0](https://github.com/TheRakeshPurohit/deepagents/compare/deepagents-code==0.1.59...deepagents-code==0.2.0) (2026-08-22)
...
* **code,talon:** require Python 3.12 or greater ([#5603](https://github.com/TheRakeshPurohit/deepagents/issues/5603)) ([04de43e](https://github.com/TheRakeshPurohit/deepagents/commit/04de43e05adcbd38f1022f1fafe93f6748c2a032))
* **code:** `/model` footer Ctrl+N hint follows display mode ([#5247](https://github.com/TheRakeshPurohit/deepagents/issues/5247)) ([cf87266](https://github.com/TheRakeshPurohit/deepagents/commit/cf87266105ee6ed79e56d72dea58c1c5f431228f))
* **code:** `Ctrl+S` in `/auto model` stores `[models].auto_classifier` ([#5313](https://github.com/TheRakeshPurohit/deepagents/issues/5313)) ([e742d04](https://github.com/TheRakeshPurohit/deepagents/commit/e742d04c8ca6f615327d7d1eab7994be8fcb3000))
* **code:** `dcode config get` accepts sections ([#5134](https://github.com/TheRakeshPurohit/deepagents/issues/5134)) ([874a137](https://github.com/TheRakeshPurohit/deepagents/commit/874a137f7bf694f647f6f1dcbcf563eae5589ef2))
* **code:** `dcode_term_program` trace metadata ([#5329](https://github.com/TheRakeshPurohit/deepagents/issues/5329)) ([8d3a1a9](https://github.com/TheRakeshPurohit/deepagents/commit/8d3a1a929f7569630060ab68862b2a21c382d58c))
* **code:** `managed_config.toml` ([#5604](https://github.com/TheRakeshPurohit/deepagents/issues/5604)) ([d419122](https://github.com/TheRakeshPurohit/deepagents/commit/d419122bfb748a823d1fa7cfd7207c428f4fbcab))
* **code:** add `/context` usage report ([#5407](https://github.com/TheRakeshPurohit/deepagents/issues/5407)) ([0355416](https://github.com/TheRakeshPurohit/deepagents/commit/0355416c0d4817ac58d3e14aa8b7ab099b6db74d))
* **code:** add `DeepSeek-V4-Pro-0813` to model picker ([#5512](https://github.com/TheRakeshPurohit/deepagents/issues/5512)) ([f23d81b](https://github.com/TheRakeshPurohit/deepagents/commit/f23d81b910b7c3343fda293d70f0a75d44f45ba0))
* **code:** add `editable` trace metadata ([#5737](https://github.com/TheRakeshPurohit/deepagents/issues/5737)) ([23b83ad](https://github.com/TheRakeshPurohit/deepagents/commit/23b83ad50f63d241d0069a3dc426d43b211adf2e))
* **code:** add `install` subcommand ([#5080](https://github.com/TheRakeshPurohit/deepagents/issues/5080)) ([2f2116d](https://github.com/TheRakeshPurohit/deepagents/commit/2f2116d5cd7bba98e1b0731d5da760a4b93ffb37))
* **code:** add `multi_select` question type to `ask_user` ([#5097](https://github.com/TheRakeshPurohit/deepagents/issues/5097)) ([878ab3e](https://github.com/TheRakeshPurohit/deepagents/commit/878ab3e20d35de63001476d5e68c29b12fad4f12))
* **code:** add Baseten built-in pricing overrides ([#5312](https://github.com/TheRakeshPurohit/deepagents/issues/5312)) ([f34ffa0](https://github.com/TheRakeshPurohit/deepagents/commit/f34ffa0cb8c0c7943b116a753535df47e32de2a3))
* **code:** add cache and context status row ([#5408](https://github.com/TheRakeshPurohit/deepagents/issues/5408)) ([2b3edf9](https://github.com/TheRakeshPurohit/deepagents/commit/2b3edf9ba4f3b43911f118b8e942374091602854))
* **code:** add Fireworks `kimi-k3` to model switcher ([#5082](https://github.com/TheRakeshPurohit/deepagents/issues/5082)) ([82e799c](https://github.com/TheRakeshPurohit/deepagents/commit/82e799c7191adcb3bf96eb0435d55edd58cc1883))
* **code:** add GLM-5.2-Fast and Kimi-K3 to recommended models ([#5072](https://github.com/TheRakeshPurohit/deepagents/issues/5072)) ([a33494e](https://github.com/TheRakeshPurohit/deepagents/commit/a33494ec580c289c58f725e19364fc21ef8cc26c))
...
* **code:** add Meta `muse-spark-1.2` to model switcher ([#5389](https://github.com/TheRakeshPurohit/deepagents/issues/5389)) ([922b285](https://github.com/TheRakeshPurohit/deepagents/commit/922b285598be3b2ca6b3ec01e7362e31ad2014b2))
* **code:** add OpenRouter `z-ai/glm-5.3` to model switcher ([#5641](https://github.com/TheRakeshPurohit/deepagents/issues/5641)) ([6295924](https://github.com/TheRakeshPurohit/deepagents/commit/6295924d428fb061945cd83940c47c765091353b))
* **code:** add project hooks workspace trust ([#5105](https://github.com/TheRakeshPurohit/deepagents/issues/5105)) ([9b2185b](https://github.com/TheRakeshPurohit/deepagents/commit/9b2185b65d4cbbaad9dd1b632162810a0aefd7eb))
* **code:** allow muting the "YOLO is active" toast ([#5103](https://github.com/TheRakeshPurohit/deepagents/issues/5103)) ([4d2d6ae](https://github.com/TheRakeshPurohit/deepagents/commit/4d2d6aed808575e2e03539bc7fa84562c93b7eb5))
* **code:** auto-update installed plugins ([#5368](https://github.com/TheRakeshPurohit/deepagents/issues/5368)) ([3bf6ca7](https://github.com/TheRakeshPurohit/deepagents/commit/3bf6ca7ac076bc0330b65d244e3b46f398674de8))
* **code:** carry `TERM_PROGRAM` into the resume hint ([#5548](https://github.com/TheRakeshPurohit/deepagents/issues/5548)) ([3cdc821](https://github.com/TheRakeshPurohit/deepagents/commit/3cdc82181bc94a904290cce23db04d8a1341b123))
* **code:** click the splash `thread` ID to copy it ([#5173](https://github.com/TheRakeshPurohit/deepagents/issues/5173)) ([be2e505](https://github.com/TheRakeshPurohit/deepagents/commit/be2e5054b9dffdf9ba9032a198c0ae5f8a0cccd1))
* **code:** configurable Auto classifier review timeout ([#5302](https://github.com/TheRakeshPurohit/deepagents/issues/5302)) ([7bd977b](https://github.com/TheRakeshPurohit/deepagents/commit/7bd977bc9d4c11aad90dbef7872d83c2affd584e))
...
* **code:** drop redundant `shell` and `web_search` prompt guidance ([#5213](https://github.com/TheRakeshPurohit/deepagents/issues/5213)) ([6305fdb](https://github.com/TheRakeshPurohit/deepagents/commit/6305fdbf8d94d061193a908715f2c629893b47ff))
* **code:** encode multi-select `ask_user` answers as JSON arrays ([#5660](https://github.com/TheRakeshPurohit/deepagents/issues/5660)) ([fc70294](https://github.com/TheRakeshPurohit/deepagents/commit/fc70294bcf9ac134c21646bcbe8546aab001442d))
* **code:** escape to manual mode in YOLO notice, mode slash commands ([#5092](https://github.com/TheRakeshPurohit/deepagents/issues/5092)) ([d93336b](https://github.com/TheRakeshPurohit/deepagents/commit/d93336bfca4664abc3994cb28970ea3fbeeb1b77))
* **code:** frame HITL rejection reasons for the model ([#5259](https://github.com/TheRakeshPurohit/deepagents/issues/5259)) ([89c814b](https://github.com/TheRakeshPurohit/deepagents/commit/89c814b29249b44a8a6122f6c359db3601a6802e))
* **code:** gate `TERM_PROGRAM` resume hints ([#5580](https://github.com/TheRakeshPurohit/deepagents/issues/5580)) ([e8035e7](https://github.com/TheRakeshPurohit/deepagents/commit/e8035e78e8be9d1edfe9a131bcc0df12349f754d))
* **code:** highlight shell commands in the chat input ([#5675](https://github.com/TheRakeshPurohit/deepagents/issues/5675)) ([d711bc6](https://github.com/TheRakeshPurohit/deepagents/commit/d711bc61300090181dc89e3e116e8b343fb65425))
...
* **code:** integrate Hooks v2 client lifecycle events ([#5104](https://github.com/TheRakeshPurohit/deepagents/issues/5104)) ([e8702df](https://github.com/TheRakeshPurohit/deepagents/commit/e8702df601e137b65fe276270c3d3d589340bddf))
* **code:** integrate Hooks v2 server lifecycle events ([#4997](https://github.com/TheRakeshPurohit/deepagents/issues/4997)) ([2487c4b](https://github.com/TheRakeshPurohit/deepagents/commit/2487c4b87dff264ae1e8d34c7ce9249dd4b29760))
...
* **code:** load hooks from installed plugins ([#5198](https://github.com/TheRakeshPurohit/deepagents/issues/5198)) ([0828b02](https://github.com/TheRakeshPurohit/deepagents/commit/0828b02d30c7b5557ecfce7c4a4039e0d9c4c571))
* **code:** local pricing overrides as a fallback when genai-prices misses ([#5304](https://github.com/TheRakeshPurohit/deepagents/issues/5304)) ([89bcaf2](https://github.com/TheRakeshPurohit/deepagents/commit/89bcaf2c31ab347cb4cb4563bc18f296dbecea08))
* **code:** make Hooks v2 generally available ([#5307](https://github.com/TheRakeshPurohit/deepagents/issues/5307)) ([4edebde](https://github.com/TheRakeshPurohit/deepagents/commit/4edebdedd61d6793f0f7b666f5ee26b414576805))
* **code:** make project `.env` loading configurable ([#5726](https://github.com/TheRakeshPurohit/deepagents/issues/5726)) ([995cad6](https://github.com/TheRakeshPurohit/deepagents/commit/995cad67519af294851282133f8c40f643807c88))
* **code:** make teardown usage stats configurable ([#5696](https://github.com/TheRakeshPurohit/deepagents/issues/5696)) ([c1d965a](https://github.com/TheRakeshPurohit/deepagents/commit/c1d965aa0db93f923ec17947fab34a5300c19141))
...
* **code:** open footer pickers on click ([#5674](https://github.com/TheRakeshPurohit/deepagents/issues/5674)) ([4f65325](https://github.com/TheRakeshPurohit/deepagents/commit/4f65325ed322ce1c650152b31532b219bfa3850c))
* **code:** open footer pickers with `ctrl+click` ([#5611](https://github.com/TheRakeshPurohit/deepagents/issues/5611)) ([ee339fb](https://github.com/TheRakeshPurohit/deepagents/commit/ee339fb8c39a1432f0cc12c181431c60b4e235f9))
* **code:** persist and reconfigure ACP sessions ([#5366](https://github.com/TheRakeshPurohit/deepagents/issues/5366)) ([22a36d2](https://github.com/TheRakeshPurohit/deepagents/commit/22a36d25d9e82902fa28cdacdcb51cd6a9b013d7))
* **code:** personalize external editor hints ([#5445](https://github.com/TheRakeshPurohit/deepagents/issues/5445)) ([b72b3dd](https://github.com/TheRakeshPurohit/deepagents/commit/b72b3dd72e0a31962ebf19261dba547462b4e394))
* **code:** point back to the previous thread after a switch ([#5172](https://github.com/TheRakeshPurohit/deepagents/issues/5172)) ([4507f9f](https://github.com/TheRakeshPurohit/deepagents/commit/4507f9f1985f29e9d4af7577293da64ec12b131c))
* **code:** prompt to reconnect when leaving `/mcp` with pending toggles ([#5211](https://github.com/TheRakeshPurohit/deepagents/issues/5211)) ([53d1fb8](https://github.com/TheRakeshPurohit/deepagents/commit/53d1fb80cbd43f983782975d540fac34a11c4ccc))
* **code:** quieter diff hunks with word-level highlights ([#5106](https://github.com/TheRakeshPurohit/deepagents/issues/5106)) ([529f7e8](https://github.com/TheRakeshPurohit/deepagents/commit/529f7e8a16c7441873a305a9fa36c2721fa7a5b7))
...
* **code:** re-auth MCP servers from viewer ([#5637](https://github.com/TheRakeshPurohit/deepagents/issues/5637)) ([d7c24d8](https://github.com/TheRakeshPurohit/deepagents/commit/d7c24d85f7b4d478116f022e1e969ddac89aeb2f))
* **code:** recognize LangSmith Gateway credentials ([#5042](https://github.com/TheRakeshPurohit/deepagents/issues/5042)) ([dcbff9c](https://github.com/TheRakeshPurohit/deepagents/commit/dcbff9c4d046bcd38ceef8e362691e8030036213))
* **code:** recommend DeepSeek V4 Flash 0731 ([#5244](https://github.com/TheRakeshPurohit/deepagents/issues/5244)) ([fbe4ec8](https://github.com/TheRakeshPurohit/deepagents/commit/fbe4ec8046c35313c6c05a986779111d84fe2536))
* **code:** refresh price catalog hourly in the background ([#5264](https://github.com/TheRakeshPurohit/deepagents/issues/5264)) ([2454afa](https://github.com/TheRakeshPurohit/deepagents/commit/2454afa58521f9dddb64bbde364a475694f45f4d))
* **code:** replace Gemini 3.6 Flash with 3.7 Flash ([#5681](https://github.com/TheRakeshPurohit/deepagents/issues/5681)) ([9446182](https://github.com/TheRakeshPurohit/deepagents/commit/94461821d8d7e1ef1f1cd29bc0212c731c195ae5))
* **code:** resize chat input by dragging its top border ([#5524](https://github.com/TheRakeshPurohit/deepagents/issues/5524)) ([d01e4ac](https://github.com/TheRakeshPurohit/deepagents/commit/d01e4ac5bf36752e5c89c1c6645d486282cb611f))
* **code:** running session cost in status bar and usage ([#5036](https://github.com/TheRakeshPurohit/deepagents/issues/5036)) ([539d4a0](https://github.com/TheRakeshPurohit/deepagents/commit/539d4a04380182438ca63ba6b902eb921dc8a600))
* **code:** selectable model for the Auto approval classifier ([#5205](https://github.com/TheRakeshPurohit/deepagents/issues/5205)) ([1d3feb1](https://github.com/TheRakeshPurohit/deepagents/commit/1d3feb1275a875f84f96f04a07e47cb6ec974b78))
* **code:** show `ask_user` answers on the answered tool row ([#5100](https://github.com/TheRakeshPurohit/deepagents/issues/5100)) ([78ebe2d](https://github.com/TheRakeshPurohit/deepagents/commit/78ebe2d27c0ec5b5bf1368f1f1b1f442f9212717))
...
* **code:** show conversation turns alongside message counts ([#5571](https://github.com/TheRakeshPurohit/deepagents/issues/5571)) ([3dd4fe5](https://github.com/TheRakeshPurohit/deepagents/commit/3dd4fe5cdc548f5408d5b74b82084d9d4c01a664))
* **code:** show thread message count in the Debug Console ([#5117](https://github.com/TheRakeshPurohit/deepagents/issues/5117)) ([04cf25d](https://github.com/TheRakeshPurohit/deepagents/commit/04cf25d27068070979552a5c914fc7dad715ce70))
* **code:** suggest compacting large resumed threads ([#5318](https://github.com/TheRakeshPurohit/deepagents/issues/5318)) ([cb2329d](https://github.com/TheRakeshPurohit/deepagents/commit/cb2329d1ec480455a7ba4e2b277cbd727c9215c7))
* **code:** support ACP approval modes ([#5394](https://github.com/TheRakeshPurohit/deepagents/issues/5394)) ([7772a14](https://github.com/TheRakeshPurohit/deepagents/commit/7772a1495440739130b8b613aa69433fbc0afbad))
* **code:** surface Hooks v2 runtime feedback ([#5045](https://github.com/TheRakeshPurohit/deepagents/issues/5045)) ([66d526f](https://github.com/TheRakeshPurohit/deepagents/commit/66d526f0e43c4c1c5d3ab9cc3d423fefe1606e6f))
* **code:** toggle diff line numbers ([#5427](https://github.com/TheRakeshPurohit/deepagents/issues/5427)) ([4cd21b6](https://github.com/TheRakeshPurohit/deepagents/commit/4cd21b61592ef0239f59cf4e3f27a2a70d226737))
* **code:** tri-state `DEEPAGENTS_CODE_ONBOARDING` env var ([#5301](https://github.com/TheRakeshPurohit/deepagents/issues/5301)) ([43293e9](https://github.com/TheRakeshPurohit/deepagents/commit/43293e95cb072c8b92a734eca8c0292e45d279e8))
* **code:** trust user-declared endpoints for cold-cache policies ([#5462](https://github.com/TheRakeshPurohit/deepagents/issues/5462)) ([107980e](https://github.com/TheRakeshPurohit/deepagents/commit/107980e387b3fa060c2b33e9bd31b57c387eddb6))
* **code:** unify notification center and settings ([#5698](https://github.com/TheRakeshPurohit/deepagents/issues/5698)) ([9767f42](https://github.com/TheRakeshPurohit/deepagents/commit/9767f420c622a31a7511c4601739534ddc6062a7))
* **code:** warn above configurable session cost threshold ([#5405](https://github.com/TheRakeshPurohit/deepagents/issues/5405)) ([8cf8517](https://github.com/TheRakeshPurohit/deepagents/commit/8cf8517e7fb728fedd07db15a0577b305cd69f70))
* **code:** warn before expensive cold-cache turns ([#5439](https://github.com/TheRakeshPurohit/deepagents/issues/5439)) ([8d2298f](https://github.com/TheRakeshPurohit/deepagents/commit/8d2298ff54797e224233349e4baf68e19b110040))
...
* **code:** align wrapped debug snapshot values ([#5727](https://github.com/TheRakeshPurohit/deepagents/issues/5727)) ([1f74959](https://github.com/TheRakeshPurohit/deepagents/commit/1f7495949232fe2e3e3328b6ff9054c202002f95))
* **code:** always restart after a successful startup auto-update ([#5317](https://github.com/TheRakeshPurohit/deepagents/issues/5317)) ([8cdee15](https://github.com/TheRakeshPurohit/deepagents/commit/8cdee15bbc54381229a686f8263656be0202b9b5))
* **code:** anchor toasts above the chat input ([#5101](https://github.com/TheRakeshPurohit/deepagents/issues/5101)) ([f1727c7](https://github.com/TheRakeshPurohit/deepagents/commit/f1727c785c44809e7b1b7ed8c5d0b31c560ae3ad))
...
* **code:** avoid detached spacer mount anchors ([#5516](https://github.com/TheRakeshPurohit/deepagents/issues/5516)) ([a38dc42](https://github.com/TheRakeshPurohit/deepagents/commit/a38dc4297b225e424207df5efd7dec0cf38ce832))
* **code:** avoid duplicate Auto denial notices ([#5501](https://github.com/TheRakeshPurohit/deepagents/issues/5501)) ([41395c5](https://github.com/TheRakeshPurohit/deepagents/commit/41395c586d9743550c27073260539724a4bfedd3))
* **code:** avoid plugin reload prompt flash ([#5500](https://github.com/TheRakeshPurohit/deepagents/issues/5500)) ([e03f030](https://github.com/TheRakeshPurohit/deepagents/commit/e03f03026984bf4bdeb8bd661707f29a4d682738))
...
* **code:** avoid transcript hydration lag ([#5479](https://github.com/TheRakeshPurohit/deepagents/issues/5479)) ([3c8cae6](https://github.com/TheRakeshPurohit/deepagents/commit/3c8cae6fa44d4e12062fdb10421b48587925eade))
* **code:** bind Auto-mode "yes" to the paired `ask_user` question ([#5038](https://github.com/TheRakeshPurohit/deepagents/issues/5038)) ([f4f138d](https://github.com/TheRakeshPurohit/deepagents/commit/f4f138db65484d4938ef3759cb26cec1e789357d))
* **code:** block dotenv git config injection keys ([#5723](https://github.com/TheRakeshPurohit/deepagents/issues/5723)) ([328f916](https://github.com/TheRakeshPurohit/deepagents/commit/328f9160e0f95a459be8ad57f76e7178b24a3ef8))
* **code:** bound Hooks v2 session-end teardown ([#5248](https://github.com/TheRakeshPurohit/deepagents/issues/5248)) ([28a7d5b](https://github.com/TheRakeshPurohit/deepagents/commit/28a7d5bdd3f78044b4f3612f71e13ce38ef47bf4))
* **code:** capture stdio MCP server stderr into the logger ([#5610](https://github.com/TheRakeshPurohit/deepagents/issues/5610)) ([a61bc6f](https://github.com/TheRakeshPurohit/deepagents/commit/a61bc6feeb6aefd780ad8435acc9ce2057fe9151))
* **code:** clarify Auto mode file-edit example ([#5685](https://github.com/TheRakeshPurohit/deepagents/issues/5685)) ([50dedf0](https://github.com/TheRakeshPurohit/deepagents/commit/50dedf086bb923ec71f585d907ac3920d0442754))
* **code:** clarify dependency warning prompt ([#5489](https://github.com/TheRakeshPurohit/deepagents/issues/5489)) ([31e4941](https://github.com/TheRakeshPurohit/deepagents/commit/31e49418c7538542ff30b2701cf8ac9d1182bbeb))
* **code:** clarify line number toggle message ([#5694](https://github.com/TheRakeshPurohit/deepagents/issues/5694)) ([bb75e96](https://github.com/TheRakeshPurohit/deepagents/commit/bb75e96192f30ffccb193f2ccdc349a0227ca1af))
* **code:** clarify project hooks trust prompt and stop prompting for user hooks ([#5426](https://github.com/TheRakeshPurohit/deepagents/issues/5426)) ([61d3279](https://github.com/TheRakeshPurohit/deepagents/commit/61d32797ef85d1380e356cd2f9de1eb7926417ec))
* **code:** clear dynamic subagents on next turn ([#5437](https://github.com/TheRakeshPurohit/deepagents/issues/5437)) ([9a37479](https://github.com/TheRakeshPurohit/deepagents/commit/9a37479f866160f92474847720b57db9598ddb3e))
* **code:** collapse resized chat input on double-click ([#5578](https://github.com/TheRakeshPurohit/deepagents/issues/5578)) ([fdde617](https://github.com/TheRakeshPurohit/deepagents/commit/fdde617eb590191162a1ebbd9a5fb6c2763ee462))
* **code:** complete the `dcode config` surface ([#5581](https://github.com/TheRakeshPurohit/deepagents/issues/5581)) ([84eb09d](https://github.com/TheRakeshPurohit/deepagents/commit/84eb09d8edaa52297ca3e2ad76a2c85a9adf4130))
* **code:** condition relative timestamp toggle ([#5503](https://github.com/TheRakeshPurohit/deepagents/issues/5503)) ([96d72a1](https://github.com/TheRakeshPurohit/deepagents/commit/96d72a188bf951c9d3ca103e6611dcb50961af93))
...
* **code:** consistent styling and links for thread status messages ([#5118](https://github.com/TheRakeshPurohit/deepagents/issues/5118)) ([9ad8dde](https://github.com/TheRakeshPurohit/deepagents/commit/9ad8dded08533a7915dc35e05f4c92c3b1ecb736))
* **code:** correct editable SDK detection to scan and correlate ([#5199](https://github.com/TheRakeshPurohit/deepagents/issues/5199)) ([4693ee7](https://github.com/TheRakeshPurohit/deepagents/commit/4693ee774771c5936ffa1783396aa4e2126211b1))
* **code:** count distinct targets in grouped tool summaries ([#5409](https://github.com/TheRakeshPurohit/deepagents/issues/5409)) ([cf8ea93](https://github.com/TheRakeshPurohit/deepagents/commit/cf8ea93a634b2ae03fa9033db6e0e240ed2ae1a1))
...
* **code:** defer plugin reload hint during startup ([#5502](https://github.com/TheRakeshPurohit/deepagents/issues/5502)) ([dc029ef](https://github.com/TheRakeshPurohit/deepagents/commit/dc029ef5072e9114125e4d332d3631dc1c3d4883))
* **code:** drain hook pipes after timeout ([#5606](https://github.com/TheRakeshPurohit/deepagents/issues/5606)) ([575a8ac](https://github.com/TheRakeshPurohit/deepagents/commit/575a8acb0307bbea9e08f4f8c15d850580a55cb3))
* **code:** drop `Muse Spark 1.1` recommendation ([#5683](https://github.com/TheRakeshPurohit/deepagents/issues/5683)) ([fa2e8ab](https://github.com/TheRakeshPurohit/deepagents/commit/fa2e8abb4da1f07163cb5ee3daff4d57ea97fe9f))
* **code:** drop redundant `/restart` hint from restart prompt ([#5083](https://github.com/TheRakeshPurohit/deepagents/issues/5083)) ([b34899f](https://github.com/TheRakeshPurohit/deepagents/commit/b34899fccd051ab741000c771eef9a2dc4439d80))
* **code:** drop the "Message restored to input" toast ([#5253](https://github.com/TheRakeshPurohit/deepagents/issues/5253)) ([c206eb4](https://github.com/TheRakeshPurohit/deepagents/commit/c206eb450d612f77924ee55ecd136fbc52f459ab))
* **code:** explain why `doctor` has no latest-version answer ([#5209](https://github.com/TheRakeshPurohit/deepagents/issues/5209)) ([ef3e078](https://github.com/TheRakeshPurohit/deepagents/commit/ef3e078795e01b8334151081d026d6a88268d5a9))
* **code:** extend text selection with `Shift` + `click` ([#5732](https://github.com/TheRakeshPurohit/deepagents/issues/5732)) ([e05931b](https://github.com/TheRakeshPurohit/deepagents/commit/e05931b3016ed3d1500df0c5b77402f457ee5686))
* **code:** fire `PreCompact` before auto-compaction ([#5277](https://github.com/TheRakeshPurohit/deepagents/issues/5277)) ([f4cc516](https://github.com/TheRakeshPurohit/deepagents/commit/f4cc5160c75eb44e8ddee8b049048690ea0f8616))
...
* **code:** gate Hooks v2 behind `DEEPAGENTS_CODE_EXPERIMENTAL` ([#5146](https://github.com/TheRakeshPurohit/deepagents/issues/5146)) ([7d4acb6](https://github.com/TheRakeshPurohit/deepagents/commit/7d4acb6804cd17eb4c2337b9af11aee9f3601d01))
...
* **code:** group resume trace rounds ([#5593](https://github.com/TheRakeshPurohit/deepagents/issues/5593)) ([345859e](https://github.com/TheRakeshPurohit/deepagents/commit/345859e8e13d5b48348efebd0a48bfb4d3fbf132))
* **code:** handle malformed hook resumes ([#5233](https://github.com/TheRakeshPurohit/deepagents/issues/5233)) ([bd562c8](https://github.com/TheRakeshPurohit/deepagents/commit/bd562c879ad3a8eec0a930bba23ef57fee163c05))
...
* **code:** hide chat input cursor while unfocused ([#5258](https://github.com/TheRakeshPurohit/deepagents/issues/5258)) ([c66d9b8](https://github.com/TheRakeshPurohit/deepagents/commit/c66d9b8500f120d6552af258750da8bb0dede7b8))
* **code:** hide dependency details after updates ([#5519](https://github.com/TheRakeshPurohit/deepagents/issues/5519)) ([cf7578d](https://github.com/TheRakeshPurohit/deepagents/commit/cf7578d1c3403bde960a43cba51f5dad7c336cb3))
* **code:** hide empty previous-thread hints ([#5552](https://github.com/TheRakeshPurohit/deepagents/issues/5552)) ([0f5bd4f](https://github.com/TheRakeshPurohit/deepagents/commit/0f5bd4f3356d0fcbdea436a27c8011629416a61c))
* **code:** hide incomplete extras from version output ([#5352](https://github.com/TheRakeshPurohit/deepagents/issues/5352)) ([38f32cd](https://github.com/TheRakeshPurohit/deepagents/commit/38f32cdbfdfcf1728178dbee85a42751dd3f3d2e))
* **code:** hide invalid cache metrics ([#5475](https://github.com/TheRakeshPurohit/deepagents/issues/5475)) ([33a57cb](https://github.com/TheRakeshPurohit/deepagents/commit/33a57cbe6808e3da5f4067b7567f77845578ff61))
* **code:** hide onboarding Tavily cancel hint ([#5684](https://github.com/TheRakeshPurohit/deepagents/issues/5684)) ([b91da61](https://github.com/TheRakeshPurohit/deepagents/commit/b91da61716253dbcf1805c6dede589ec41a09ec5))
* **code:** hide startup tips when resuming threads ([#5349](https://github.com/TheRakeshPurohit/deepagents/issues/5349)) ([ff421f2](https://github.com/TheRakeshPurohit/deepagents/commit/ff421f2f316f3819d8ac92225ea032dabfbcefe9))
* **code:** hide thread IDs when tracing is disabled ([#5692](https://github.com/TheRakeshPurohit/deepagents/issues/5692)) ([1680237](https://github.com/TheRakeshPurohit/deepagents/commit/1680237e69bf27740001df7a7f67de5a053536c1))
* **code:** hide timestamp footers with the rows they belong to ([#5167](https://github.com/TheRakeshPurohit/deepagents/issues/5167)) ([a3e3798](https://github.com/TheRakeshPurohit/deepagents/commit/a3e3798599705afd2d0a3fce8116df61f22a551d))
...
* **code:** ignore mouse hits on detached widgets ([#5114](https://github.com/TheRakeshPurohit/deepagents/issues/5114)) ([d4d2b60](https://github.com/TheRakeshPurohit/deepagents/commit/d4d2b60e37ae034e69f60ab5f34267b542c00dd5))
...
* **code:** increase warm limit to 800 ([#5728](https://github.com/TheRakeshPurohit/deepagents/issues/5728)) ([f954cde](https://github.com/TheRakeshPurohit/deepagents/commit/f954cde37f1171adc2ec3f1516a0393bded47e82))
* **code:** indent wrapped ask-user choices and add selection styling ([#5442](https://github.com/TheRakeshPurohit/deepagents/issues/5442)) ([a78d7b1](https://github.com/TheRakeshPurohit/deepagents/commit/a78d7b1744050c3221aab5e0c0300cc5f5bec519))
...
* **code:** keep `/update` and `/install --package` prompts responsive ([#5127](https://github.com/TheRakeshPurohit/deepagents/issues/5127)) ([5726872](https://github.com/TheRakeshPurohit/deepagents/commit/5726872cd5efec9367ae2ce678aa7183af74335d))
* **code:** keep chat input responsive during `/reload` ([#5529](https://github.com/TheRakeshPurohit/deepagents/issues/5529)) ([5aa266e](https://github.com/TheRakeshPurohit/deepagents/commit/5aa266eab5ca0aedee58367c63599a926863d2cf))
...
* **code:** keep installed providers visible in `/auth` ([#5689](https://github.com/TheRakeshPurohit/deepagents/issues/5689)) ([f0854e8](https://github.com/TheRakeshPurohit/deepagents/commit/f0854e82ed8cedd8a8455539eef596d1433eb68e))
* **code:** keep MCP shutdown-race traceback off the terminal ([#5325](https://github.com/TheRakeshPurohit/deepagents/issues/5325)) ([7d97097](https://github.com/TheRakeshPurohit/deepagents/commit/7d9709700dd24cc2477cd091f01de990f23ee4a9))
* **code:** keep post-install restart modal responsive ([#5086](https://github.com/TheRakeshPurohit/deepagents/issues/5086)) ([c4e2480](https://github.com/TheRakeshPurohit/deepagents/commit/c4e24804ebde93563f0596102bd5d9fc163ec0bf))
* **code:** keep rapid typing visible ([#5424](https://github.com/TheRakeshPurohit/deepagents/issues/5424)) ([6a7c7d6](https://github.com/TheRakeshPurohit/deepagents/commit/6a7c7d6575915dbc4b1549133735f50666919979))
* **code:** keep server hook state out of task results ([#5164](https://github.com/TheRakeshPurohit/deepagents/issues/5164)) ([88ea7da](https://github.com/TheRakeshPurohit/deepagents/commit/88ea7da18e8be84e65df0edb8ffc4b904182f843))
* **code:** keep the `/goal` criteria prompt responsive ([#5142](https://github.com/TheRakeshPurohit/deepagents/issues/5142)) ([6f9ea6a](https://github.com/TheRakeshPurohit/deepagents/commit/6f9ea6a943dabe6c055766a43a204db6f4d95c98))
* **code:** let MCP footer wrap on narrow windows ([#5651](https://github.com/TheRakeshPurohit/deepagents/issues/5651)) ([d00926e](https://github.com/TheRakeshPurohit/deepagents/commit/d00926e9e0278d6e74f91622b00d1375c7af19ab))
...
* **code:** make `/offload` interruptible ([#5590](https://github.com/TheRakeshPurohit/deepagents/issues/5590)) ([ab82d48](https://github.com/TheRakeshPurohit/deepagents/commit/ab82d48cc012c5a991660ad53785c2e26030596e))
...
* **code:** make reject-with-feedback discoverable in approval menu ([#5260](https://github.com/TheRakeshPurohit/deepagents/issues/5260)) ([b1e3240](https://github.com/TheRakeshPurohit/deepagents/commit/b1e324038771c55460793e2e35d9d9ce5ea7b3f5))
* **code:** make tool arg validation errors recoverable ([#5659](https://github.com/TheRakeshPurohit/deepagents/issues/5659)) ([a7027ed](https://github.com/TheRakeshPurohit/deepagents/commit/a7027edc6449e9a7dbf0e082b8747d0999125ca2))
* **code:** offload server graph bootstrap cwd calls off the event loop ([#5081](https://github.com/TheRakeshPurohit/deepagents/issues/5081)) ([e05f7c2](https://github.com/TheRakeshPurohit/deepagents/commit/e05f7c2a825f3dc2fdfc075d4092b7b15d89b1a9))
...
* **code:** omit unavailable web-search prompt guidance ([#5602](https://github.com/TheRakeshPurohit/deepagents/issues/5602)) ([9feaf51](https://github.com/TheRakeshPurohit/deepagents/commit/9feaf51030a30203f43231b7fb9420293be9fedc))
* **code:** open `/auto model` selector immediately while connecting ([#5341](https://github.com/TheRakeshPurohit/deepagents/issues/5341)) ([72bfc1e](https://github.com/TheRakeshPurohit/deepagents/commit/72bfc1e68574909ceb929be869c66fbdc9fe5a1d))
* **code:** persist Auto approval mode between sessions ([#5665](https://github.com/TheRakeshPurohit/deepagents/issues/5665)) ([3ac059e](https://github.com/TheRakeshPurohit/deepagents/commit/3ac059e1574963fe216692642aa1b1a4044daaa9))
* **code:** preload auth UI before notification handoff ([#5697](https://github.com/TheRakeshPurohit/deepagents/issues/5697)) ([57c0678](https://github.com/TheRakeshPurohit/deepagents/commit/57c0678c4994b8b253c5f7edf11b7a558ece7df9))
* **code:** preserve editables during dependency refresh ([#5521](https://github.com/TheRakeshPurohit/deepagents/issues/5521)) ([f0446c8](https://github.com/TheRakeshPurohit/deepagents/commit/f0446c8c8aecff243545fe0c551a6539ccf482a2))
* **code:** preserve runtime offload archive routing ([#5328](https://github.com/TheRakeshPurohit/deepagents/issues/5328)) ([768b061](https://github.com/TheRakeshPurohit/deepagents/commit/768b061805f65a36c71a1ad8f6a41b4e67063e91))
* **code:** prevent post-tool hook replay ([#5376](https://github.com/TheRakeshPurohit/deepagents/issues/5376)) ([d37b54f](https://github.com/TheRakeshPurohit/deepagents/commit/d37b54f6bfb03f41fc7ff6b05436ad49db688d19))
...
* **code:** queue `/copy` during active generation ([#5447](https://github.com/TheRakeshPurohit/deepagents/issues/5447)) ([8dfe282](https://github.com/TheRakeshPurohit/deepagents/commit/8dfe282006108dd0c47c50d5a1e3a41558e14723))
* **code:** ranked durable-mask config resolver ([#5672](https://github.com/TheRakeshPurohit/deepagents/issues/5672)) ([9f24b9f](https://github.com/TheRakeshPurohit/deepagents/commit/9f24b9fcaf7ed399b7888b2f0f9d13363939ea87))
* **code:** refresh hooks after cwd switches ([#5249](https://github.com/TheRakeshPurohit/deepagents/issues/5249)) ([6f48dd5](https://github.com/TheRakeshPurohit/deepagents/commit/6f48dd59efd27c3476cf32cb8c965155c59993a5))
* **code:** refresh splash version after update ([#5520](https://github.com/TheRakeshPurohit/deepagents/issues/5520)) ([c2ec5e6](https://github.com/TheRakeshPurohit/deepagents/commit/c2ec5e6d9f85bf114a3666bba982de0c63ec5eb5))
* **code:** release the turn when an interrupted worker never starts ([#5196](https://github.com/TheRakeshPurohit/deepagents/issues/5196)) ([42e01a9](https://github.com/TheRakeshPurohit/deepagents/commit/42e01a9585be8847aff6b97e520d7b84de922767))
* **code:** remove notification settings expand flicker and trailing disclosure glyph ([#5734](https://github.com/TheRakeshPurohit/deepagents/issues/5734)) ([5397812](https://github.com/TheRakeshPurohit/deepagents/commit/5397812ad5f217cd84f871f121cf9ea8f3d63f4f))
* **code:** remove optional-provider startup tip ([#5421](https://github.com/TheRakeshPurohit/deepagents/issues/5421)) ([f137897](https://github.com/TheRakeshPurohit/deepagents/commit/f1378978e20f94762601ed38787a6fdb7fb39784))
* **code:** remove plugin type-to-search caret flash ([#5078](https://github.com/TheRakeshPurohit/deepagents/issues/5078)) ([7d69e37](https://github.com/TheRakeshPurohit/deepagents/commit/7d69e379678d8491ab62c9e229426d50b7366c45))
* **code:** remove review failure approval copy ([#5687](https://github.com/TheRakeshPurohit/deepagents/issues/5687)) ([b6a4146](https://github.com/TheRakeshPurohit/deepagents/commit/b6a41461d1834f673795e39a8928649de142d976))
* **code:** remove undispatched `SessionEndCause` members ([#5240](https://github.com/TheRakeshPurohit/deepagents/issues/5240)) ([ee1e0f5](https://github.com/TheRakeshPurohit/deepagents/commit/ee1e0f50bfaff3690c6164147cdf22c94c289768))
* **code:** rename OpenAI subscription login label ([#5680](https://github.com/TheRakeshPurohit/deepagents/issues/5680)) ([14b09aa](https://github.com/TheRakeshPurohit/deepagents/commit/14b09aa18567de9325bbf7fa083fe339c90fce0e))
...
* **code:** report MCP server changes on reload ([#5504](https://github.com/TheRakeshPurohit/deepagents/issues/5504)) ([b16a740](https://github.com/TheRakeshPurohit/deepagents/commit/b16a74085af0057a24ce00f23a6a165bf5f21ed2))
* **code:** report total context after `/offload` ([#5488](https://github.com/TheRakeshPurohit/deepagents/issues/5488)) ([5d806c8](https://github.com/TheRakeshPurohit/deepagents/commit/5d806c88cf2a8b10d9b13b832540151491c13e19))
* **code:** require `AGENTS.md` marker for `/agent` discovery ([#5076](https://github.com/TheRakeshPurohit/deepagents/issues/5076)) ([aff1435](https://github.com/TheRakeshPurohit/deepagents/commit/aff1435ce8d56c623cfeffb2731adcd4bf057c30)), closes [#4991](https://github.com/TheRakeshPurohit/deepagents/issues/4991)
* **code:** resolve message pointer shapes per cell ([#5592](https://github.com/TheRakeshPurohit/deepagents/issues/5592)) ([cd4c399](https://github.com/TheRakeshPurohit/deepagents/commit/cd4c3993faf9aabfc6bb6c22bb56a57c33563106))
* **code:** resolve underspecified goal objectives from conversation context ([#5201](https://github.com/TheRakeshPurohit/deepagents/issues/5201)) ([8fdb9c3](https://github.com/TheRakeshPurohit/deepagents/commit/8fdb9c306fd9a5b5368eb065b100cbfe8c8cbc58))
...
* **code:** restore edit diffs in resumed threads ([#5391](https://github.com/TheRakeshPurohit/deepagents/issues/5391)) ([6a5d93f](https://github.com/TheRakeshPurohit/deepagents/commit/6a5d93f9ba7391189f65e6b999b724253577085d))
* **code:** resume hints echo the launched command name ([#5119](https://github.com/TheRakeshPurohit/deepagents/issues/5119)) ([991b7e7](https://github.com/TheRakeshPurohit/deepagents/commit/991b7e769d8afa98edc8dac1c68994ca4dc765d2))
* **code:** route failures to `PostToolUseFailure` ([#5315](https://github.com/TheRakeshPurohit/deepagents/issues/5315)) ([c1f4ac3](https://github.com/TheRakeshPurohit/deepagents/commit/c1f4ac3d53b3231d80be97691763850d230e8080))
* **code:** scope selection copy to the clicked screen ([#5140](https://github.com/TheRakeshPurohit/deepagents/issues/5140)) ([4de6037](https://github.com/TheRakeshPurohit/deepagents/commit/4de6037cbe31de005a493eaa719f5269f29be764))
* **code:** scroll resumed threads to the bottom ([#5543](https://github.com/TheRakeshPurohit/deepagents/issues/5543)) ([1c6d358](https://github.com/TheRakeshPurohit/deepagents/commit/1c6d358c60306aad2af0067dcca76f85f4deeba1))
* **code:** separate YOLO exit hint ([#5688](https://github.com/TheRakeshPurohit/deepagents/issues/5688)) ([5d604ee](https://github.com/TheRakeshPurohit/deepagents/commit/5d604eed6d7ff567bb6c2c3046e385fc8d987698))
* **code:** serialize dcode self-upgrades across processes ([#5252](https://github.com/TheRakeshPurohit/deepagents/issues/5252)) ([e12acba](https://github.com/TheRakeshPurohit/deepagents/commit/e12acbac89e553048b03fb6132b53e61b3433271))
* **code:** shorten Auto classifier selection message ([#5446](https://github.com/TheRakeshPurohit/deepagents/issues/5446)) ([c43919c](https://github.com/TheRakeshPurohit/deepagents/commit/c43919c5c05643d03cf00009339cd0e4d3c17d6d))
...
* **code:** show Auto first-enable notice as pre-confirmation ([#5686](https://github.com/TheRakeshPurohit/deepagents/issues/5686)) ([32f565f](https://github.com/TheRakeshPurohit/deepagents/commit/32f565f46519d9c35919640bdf9374506d0572d2))
* **code:** show contextual auth footer actions ([#5690](https://github.com/TheRakeshPurohit/deepagents/issues/5690)) ([074a501](https://github.com/TheRakeshPurohit/deepagents/commit/074a5019e1f3edfd589614774958400d051e5fe1))
* **code:** show resume hint after crashes ([#5412](https://github.com/TheRakeshPurohit/deepagents/issues/5412)) ([015a019](https://github.com/TheRakeshPurohit/deepagents/commit/015a0197f588e34475db63c2a03f04987583b081))
...
* **code:** simplify Auto fallback copy ([#5670](https://github.com/TheRakeshPurohit/deepagents/issues/5670)) ([42afcde](https://github.com/TheRakeshPurohit/deepagents/commit/42afcded97029070f393232778c84aaf3b69fb1c))
* **code:** simplify classifier notice copy ([#5691](https://github.com/TheRakeshPurohit/deepagents/issues/5691)) ([c23c960](https://github.com/TheRakeshPurohit/deepagents/commit/c23c960459e931631842f1a7214b98a2d383f72a))
* **code:** simplify empty `/tokens` message ([#5693](https://github.com/TheRakeshPurohit/deepagents/issues/5693)) ([8a4fc3a](https://github.com/TheRakeshPurohit/deepagents/commit/8a4fc3a3104ab5131bedec0ca1f76289285d5efa))
* **code:** simplify paste expansion toast ([#5443](https://github.com/TheRakeshPurohit/deepagents/issues/5443)) ([217b9eb](https://github.com/TheRakeshPurohit/deepagents/commit/217b9eb372fa51b0439434f31abc3ac22e6cd7f2))
* **code:** skip background sync in Apple Terminal ([#5666](https://github.com/TheRakeshPurohit/deepagents/issues/5666)) ([a2782ff](https://github.com/TheRakeshPurohit/deepagents/commit/a2782ff36efd5e9c9ebd9abb17b6fb51a2f01e8b))
* **code:** stabilize hook resumes across identity and Command tool results ([#5176](https://github.com/TheRakeshPurohit/deepagents/issues/5176)) ([08e6e8b](https://github.com/TheRakeshPurohit/deepagents/commit/08e6e8ba8d8ea629d78976542a061a2acab1fa9c))
* **code:** standardize modal navigation hints ([#5699](https://github.com/TheRakeshPurohit/deepagents/issues/5699)) ([85c6833](https://github.com/TheRakeshPurohit/deepagents/commit/85c6833734a547e968221c1199a769d7aac69430))
* **code:** stop duplicating Auto transcript events on interrupt replay ([#5157](https://github.com/TheRakeshPurohit/deepagents/issues/5157)) ([5bbcf42](https://github.com/TheRakeshPurohit/deepagents/commit/5bbcf428a8131f0fca149abba34096fbcd2dfde8))
* **code:** stop leaking turn coroutines and sqlite handles ([#5218](https://github.com/TheRakeshPurohit/deepagents/issues/5218)) ([994799b](https://github.com/TheRakeshPurohit/deepagents/commit/994799b2f25950eb76e1085b5026d1f19eceb563))
* **code:** stop passing removed `checkpoint_metadata` ([#5473](https://github.com/TheRakeshPurohit/deepagents/issues/5473)) ([61ae398](https://github.com/TheRakeshPurohit/deepagents/commit/61ae398a60a2f6c23954d89332950570e0b6b431))
* **code:** store update logs under the OS cache dir ([#5363](https://github.com/TheRakeshPurohit/deepagents/issues/5363)) ([f69804b](https://github.com/TheRakeshPurohit/deepagents/commit/f69804bfce2673de4f2171664ac5b91c1c248ea0))
* **code:** stream tool-call args in linear time ([#5712](https://github.com/TheRakeshPurohit/deepagents/issues/5712)) ([57bfa6b](https://github.com/TheRakeshPurohit/deepagents/commit/57bfa6bdc57056265047744dc32f3337a964ddc8))
* **code:** surface hook stops without agent errors ([#5276](https://github.com/TheRakeshPurohit/deepagents/issues/5276)) ([ed0e3e2](https://github.com/TheRakeshPurohit/deepagents/commit/ed0e3e236eea691d7c8c586ac1f9c82eba352b1a))
* **code:** thread `session_id` through forced-compaction fork ([#5492](https://github.com/TheRakeshPurohit/deepagents/issues/5492)) ([33d323c](https://github.com/TheRakeshPurohit/deepagents/commit/33d323c98bda90c7fe75bcf4a44fb083ed87fa81))
* **code:** toast and expand long transcript user messages ([#5073](https://github.com/TheRakeshPurohit/deepagents/issues/5073)) ([a34713b](https://github.com/TheRakeshPurohit/deepagents/commit/a34713b122383dccad2572cd7213fd56f467fcce))
* **code:** toast model no-op notice instead of inline message ([#5074](https://github.com/TheRakeshPurohit/deepagents/issues/5074)) ([92b5193](https://github.com/TheRakeshPurohit/deepagents/commit/92b519391f584acb7786121469e45e850a94e06c))
* **code:** toast when media is dropped into a free-text question ([#5099](https://github.com/TheRakeshPurohit/deepagents/issues/5099)) ([da8d4c3](https://github.com/TheRakeshPurohit/deepagents/commit/da8d4c3ccc237e57294088d2437b13031a73c52d))
...
* **code:** use dismissed copy for ask-user prompts ([#5331](https://github.com/TheRakeshPurohit/deepagents/issues/5331)) ([920fb66](https://github.com/TheRakeshPurohit/deepagents/commit/920fb66763e85b759c2ec3cac090bccd7f05b55f))
* **code:** warn on stale dependencies in editable installs ([#5386](https://github.com/TheRakeshPurohit/deepagents/issues/5386)) ([10353bd](https://github.com/TheRakeshPurohit/deepagents/commit/10353bda7196f307db9b22ef1173764aeda6daa7))


### Performance Improvements

* **code:** refresh `/threads` cache after each turn ([#5174](https://github.com/TheRakeshPurohit/deepagents/issues/5174)) ([872f9d5](https://github.com/TheRakeshPurohit/deepagents/commit/872f9d5647759a84e7abfa79d43fc128c54e29a4))
