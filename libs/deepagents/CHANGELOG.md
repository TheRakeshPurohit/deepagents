...
## [0.7.20](https://github.com/TheRakeshPurohit/deepagents/compare/deepagents==0.7.19...deepagents==0.7.20) (2026-09-26)
...
* **sdk:** add rubric grader integration hooks ([#5874](https://github.com/TheRakeshPurohit/deepagents/issues/5874)) ([07c0340](https://github.com/TheRakeshPurohit/deepagents/commit/07c0340bc41e3717f1cd73705b71f1f6a87d753f))
* **sdk:** add subagent conversation forking ([#5714](https://github.com/TheRakeshPurohit/deepagents/issues/5714)) ([6b4427f](https://github.com/TheRakeshPurohit/deepagents/commit/6b4427f07dc35a0b61cf8224db090ea6bee6f72f))
* **sdk:** disable tracing inputs on middleware ([#5377](https://github.com/TheRakeshPurohit/deepagents/issues/5377)) ([0aade99](https://github.com/TheRakeshPurohit/deepagents/commit/0aade99211dc45cc85ce8b95fc375612f982b48a))
* **sdk:** reload skills when `skills_metadata` is reset to `None` ([#6364](https://github.com/TheRakeshPurohit/deepagents/issues/6364)) ([f86b4e9](https://github.com/TheRakeshPurohit/deepagents/commit/f86b4e9abef7620b63a7258bc9fab0ccd83de8a4))


### Bug Fixes

* **sdk:** allow colons in profile model keys ([#6334](https://github.com/TheRakeshPurohit/deepagents/issues/6334)) ([257872e](https://github.com/TheRakeshPurohit/deepagents/commit/257872eea59368a0c3aac003f71d3c83ce44c833))
* **sdk:** bound compaction recovery and validate input budgets ([#6267](https://github.com/TheRakeshPurohit/deepagents/issues/6267)) ([bb6d431](https://github.com/TheRakeshPurohit/deepagents/commit/bb6d4316eb59b368b862e5517b888e5e70b1c3ae))
* **sdk:** bound tool offload paths and abbreviate long IDs ([#6519](https://github.com/TheRakeshPurohit/deepagents/issues/6519)) ([ca5f0e5](https://github.com/TheRakeshPurohit/deepagents/commit/ca5f0e5eae7ee749e81ae8e9e3bbc1762447fcc2))
* **sdk:** disclose byte-cap losses in capture-offload execute previews ([#5567](https://github.com/TheRakeshPurohit/deepagents/issues/5567)) ([dbdd6fb](https://github.com/TheRakeshPurohit/deepagents/commit/dbdd6fbb47f340de8d23092187aa2882242963f8))
* **sdk:** disclose per-line clipping in large-result previews ([#5564](https://github.com/TheRakeshPurohit/deepagents/issues/5564)) ([5014cf7](https://github.com/TheRakeshPurohit/deepagents/commit/5014cf7f7480c5e080095c9e3396e4ce93421053))
* **sdk:** enforce full criterion coverage in `RubricMiddleware` ([#5234](https://github.com/TheRakeshPurohit/deepagents/issues/5234)) ([ddb69b6](https://github.com/TheRakeshPurohit/deepagents/commit/ddb69b609a02d7203cda7f3ea2796ca73e5b5795))
* **sdk:** exclude tools from execution when setting `excluded_tools` in harness profiles ([#5809](https://github.com/TheRakeshPurohit/deepagents/issues/5809)) ([553d412](https://github.com/TheRakeshPurohit/deepagents/commit/553d412bb4f4b868fbf080ab561f76b4dd335f52))
* **sdk:** explain truncation markers only when preview omits lines ([#5563](https://github.com/TheRakeshPurohit/deepagents/issues/5563)) ([7b4fcd3](https://github.com/TheRakeshPurohit/deepagents/commit/7b4fcd398b2a9bcd875b193c32d1eb97f152ce21))
* **sdk:** fix character counting in `ls` and `glob` output ([#6204](https://github.com/TheRakeshPurohit/deepagents/issues/6204)) ([4ca678f](https://github.com/TheRakeshPurohit/deepagents/commit/4ca678fe11fcb8f452b59b31923f37dabbc26d6a))
* **sdk:** give id-less tool result offloads unique paths ([#6316](https://github.com/TheRakeshPurohit/deepagents/issues/6316)) ([a0c2ad0](https://github.com/TheRakeshPurohit/deepagents/commit/a0c2ad03c6dcd52340e91bea6483ee7750d5deee))
* **sdk:** keep blank read windows out of the empty-file warning ([#5050](https://github.com/TheRakeshPurohit/deepagents/issues/5050)) ([a892a0e](https://github.com/TheRakeshPurohit/deepagents/commit/a892a0ee26d045256b6d3b0c224b3de663c83eb5))
* **sdk:** patch invalid partial tool calls ([#5430](https://github.com/TheRakeshPurohit/deepagents/issues/5430)) ([edc7c1c](https://github.com/TheRakeshPurohit/deepagents/commit/edc7c1ca69831c1827c1f479696a5450ffd1df9d))
* **sdk:** preserve backend exit status when capture metadata is missing ([#6451](https://github.com/TheRakeshPurohit/deepagents/issues/6451)) ([c9926b1](https://github.com/TheRakeshPurohit/deepagents/commit/c9926b1a96d204309d0b211701b288ce3bb4244b))
* **sdk:** preserve legacy large-result templates behind deprecation ([#5568](https://github.com/TheRakeshPurohit/deepagents/issues/5568)) ([4932d70](https://github.com/TheRakeshPurohit/deepagents/commit/4932d7066fc9f3464921ab72d5d86922ea4b26ec))
* **sdk:** prevent local shell commands from stealing TUI input ([#5873](https://github.com/TheRakeshPurohit/deepagents/issues/5873)) ([c94a090](https://github.com/TheRakeshPurohit/deepagents/commit/c94a090c1b21918c9e4eced52ecb4e3bf7476f43))
* **sdk:** propagate subagent state keys for provided subagent middleware ([#5553](https://github.com/TheRakeshPurohit/deepagents/issues/5553)) ([ff8dda9](https://github.com/TheRakeshPurohit/deepagents/commit/ff8dda912b0d1651f234b9d49cec06e79b7c1b6b))
* **sdk:** recover from rejected `read_file` media ([#6515](https://github.com/TheRakeshPurohit/deepagents/issues/6515)) ([802140c](https://github.com/TheRakeshPurohit/deepagents/commit/802140c1a7d1fff35a7edd8d0f1697eb460ce623))
* **sdk:** reject empty old_string in edit_file paths ([#5747](https://github.com/TheRakeshPurohit/deepagents/issues/5747)) ([1281b04](https://github.com/TheRakeshPurohit/deepagents/commit/1281b04f7eafaf654982b99a3c93f72744208eda))
* **sdk:** reject parallel same-file edits ([#6446](https://github.com/TheRakeshPurohit/deepagents/issues/6446)) ([2e2ee91](https://github.com/TheRakeshPurohit/deepagents/commit/2e2ee91b794ed549b299445b7bb5de641e9a4f4d))
* **sdk:** reject unknown keys in the task tool arguments ([#6299](https://github.com/TheRakeshPurohit/deepagents/issues/6299)) ([00fef9c](https://github.com/TheRakeshPurohit/deepagents/commit/00fef9c012b20f91785dc5e83c642fb439832178))
* **sdk:** rename `handoff` subagent mode to `isolated` ([#6030](https://github.com/TheRakeshPurohit/deepagents/issues/6030)) ([15454a8](https://github.com/TheRakeshPurohit/deepagents/commit/15454a85438146a59c804af3a525f96091c55fe8))
* **sdk:** report UTF-8 byte sizes ([#6258](https://github.com/TheRakeshPurohit/deepagents/issues/6258)) ([5bac4aa](https://github.com/TheRakeshPurohit/deepagents/commit/5bac4aae53494329a533294564353b10c3385244))
* **sdk:** require a real Nemotron task transition ([#6296](https://github.com/TheRakeshPurohit/deepagents/issues/6296)) ([3d6392e](https://github.com/TheRakeshPurohit/deepagents/commit/3d6392e82408c1a5e24d0c1d32c53934552fd314))
* **sdk:** restrict inline file blocks to supported MIME types ([#6447](https://github.com/TheRakeshPurohit/deepagents/issues/6447)) ([191e93a](https://github.com/TheRakeshPurohit/deepagents/commit/191e93a05e30aad705ee2cb33d5b03e7104dbe5a))
* **sdk:** suggest populating path in `glob` tool result where appropriate ([#6199](https://github.com/TheRakeshPurohit/deepagents/issues/6199)) ([26954ea](https://github.com/TheRakeshPurohit/deepagents/commit/26954eaafb581db641dd7ce3f9d4ba470a9af878))
* **sdk:** surface sandbox glob failures instead of reporting no matches ([#5566](https://github.com/TheRakeshPurohit/deepagents/issues/5566)) ([0286f62](https://github.com/TheRakeshPurohit/deepagents/commit/0286f628646d4196e5e89164b45803fb7b97a0cc))
* **sdk:** tolerate missing `modified_at` in glob sort ([#4376](https://github.com/TheRakeshPurohit/deepagents/issues/4376)) ([09b2e53](https://github.com/TheRakeshPurohit/deepagents/commit/09b2e53617968a06c2b4ee6d821fca71a1d94d49))
* **sdk:** update imputed `ToolMessage` content in `PatchToolCallsMiddleware` ([#6277](https://github.com/TheRakeshPurohit/deepagents/issues/6277)) ([178417d](https://github.com/TheRakeshPurohit/deepagents/commit/178417d0dad063fea0300db68455f4574ef67db3))
* **sdk:** use separate middleware for filtering unsupported multimodal content ([#6366](https://github.com/TheRakeshPurohit/deepagents/issues/6366)) ([737621b](https://github.com/TheRakeshPurohit/deepagents/commit/737621ba73c39ac822c78c144612336bd02de6fb))
