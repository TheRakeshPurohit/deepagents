...
## [0.8.0](https://github.com/TheRakeshPurohit/deepagents/compare/deepagents==0.7.5...deepagents==0.8.0) (2026-08-08)
...
* **sdk:** expose `execute` exit code in artifact ([#5300](https://github.com/TheRakeshPurohit/deepagents/issues/5300)) ([de8bfca](https://github.com/TheRakeshPurohit/deepagents/commit/de8bfca8255d673c1e7860e8c158ed119238197e))
* **sdk:** mark editable installs in `lc_versions.deepagents` ([#5158](https://github.com/TheRakeshPurohit/deepagents/issues/5158)) ([ee7ac3d](https://github.com/TheRakeshPurohit/deepagents/commit/ee7ac3d47980e4037403bfea1a13b7b51e06fb4a))
...
* **sdk:** empty read for degenerate `read_file` windows ([#5184](https://github.com/TheRakeshPurohit/deepagents/issues/5184)) ([6bf3b68](https://github.com/TheRakeshPurohit/deepagents/commit/6bf3b68441e04e9e25883a4f91e6b8d0d6c15703))
* **sdk:** identify file-capable provider classes ([#5326](https://github.com/TheRakeshPurohit/deepagents/issues/5326)) ([e5d5391](https://github.com/TheRakeshPurohit/deepagents/commit/e5d53917c01aadcebe4e7e4a1974322033ae6c87))
...
* **sdk:** resolve exact-file `delete` targets with first-match-wins o… ([#5229](https://github.com/TheRakeshPurohit/deepagents/issues/5229)) ([6dd2a7d](https://github.com/TheRakeshPurohit/deepagents/commit/6dd2a7d2f83bd63844a987f6ec65ac9244ec8c5b))
* **sdk:** scrub multimodal content blocks unsupported by the model's profile ([#5194](https://github.com/TheRakeshPurohit/deepagents/issues/5194)) ([bdc6104](https://github.com/TheRakeshPurohit/deepagents/commit/bdc610445534ba339360f3988de6b50b60482f1d))
* **sdk:** warn instead of silently skipping unresolved state schemas ([#5166](https://github.com/TheRakeshPurohit/deepagents/issues/5166)) ([2054c07](https://github.com/TheRakeshPurohit/deepagents/commit/2054c078071b4248707c2b28c7e5254e36703e66))


### Performance Improvements

* **langsmith-sandbox:** run LangSmith sandbox commands over the async client ([#5061](https://github.com/TheRakeshPurohit/deepagents/issues/5061)) ([0d08747](https://github.com/TheRakeshPurohit/deepagents/commit/0d0874710615df2c89c3c30e56bfdabb73b44d99))
